...
using DtbseFirstprcoh.Models;

namespace DtbseFirstprcoh.Controllers
{
    public class employeeDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmpId,EmpName,EmpSalary,DeptId,Designation,DeptName")] employeeDetail employeeDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmpId,EmpName,EmpSalary,DeptId,Designation,DeptName")] employeeDetail employeeDetail)
        {
            if (ModelState.IsValid)
            {
